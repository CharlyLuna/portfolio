...
export const Form = () => {
  ...
  return (
    <form ref={form} onSubmit={handleSubmit} className='flex flex-col gap-2 text-secondary shadow-lg bg-[#eee] py-8 px-4 w-[80%] md:w-[50%] max-w-[450px]'>
      ...
      <input required id='name' aria-required className='p-2 rounded-sm ' type='text' name='name' />
      <label htmlFor='email'>Email</label>
      <input required id='email' aria-required className='p-2 rounded-sm ' type='email' name='email' />
      <label htmlFor='message'>Message</label>
      <textarea required id='message' aria-required className='p-2 rounded-sm h-[100px] min-h-[100px]' type='text' name='message' />
