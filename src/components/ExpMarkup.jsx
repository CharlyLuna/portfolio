...
export const ExpMarkup = ({ title, date, tags, description }) => {
  return (
    <div className='flex flex-col md:flex-row gap-4 relative group'>
      <div className='absolute -inset-x-4 -inset-y-4 z-0 opacity-50 lg:group-hover:bg-black/20 lg:group-hover:shadow-[inset_0_1px_var(--primary-red-200)] lg:drop-shadow-xl transition-all duration-300 rounded-md' />
