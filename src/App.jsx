    ...
    <>
      ...
      <section id='projects' className='mb-20'>
        ...
        <div className='mx-10 flex justify-center'>
          <ul className='group/list grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-3 m-0 xl:w-full xl:max-w-7xl
          justify-items-center'
          >
            {
              PROJECTS.map((project, index) => (
                <li className='lg:group-hover/list:opacity-80 lg:hover:!opacity-100 transition-all ' key={`${project}_${index}`}>
                  <ProjectCard {...project} />
                </li>
              ))
            }
